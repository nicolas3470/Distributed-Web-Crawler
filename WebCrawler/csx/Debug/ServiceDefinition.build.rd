...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="WebCrawler" generation="1" functional="0" release="0" Id="6e8434f6-742f-47e1-a443-0cd61f94c555" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="WebCrawlerGroup" generation="1" functional="0" release="0">
      ...
      <settings>
        ...
        <aCS name="UserInterface:CrawlerStorage" defaultValue="">
          <maps>
            <mapMoniker name="/WebCrawler/WebCrawlerGroup/MapUserInterface:CrawlerStorage" />
          </maps>
        </aCS>
      ...
      <maps>
        ...
        <map name="MapUserInterface:CrawlerStorage" kind="Identity">
          <setting>
            <aCSMoniker name="/WebCrawler/WebCrawlerGroup/UserInterface/CrawlerStorage" />
          </setting>
        </map>
      ...
      <components>
        ...
        <groupHascomponents>
          <role name="WebCrawlerRole" generation="1" functional="0" release="0" software="C:\Users\Nicolas\documents\visual studio 2010\Projects\WebCrawler\WebCrawler\csx\Debug\roles\WebCrawlerRole" entryPoint="base\x86\WaHostBootstrapper.exe" parameters="base\x86\WaWorkerHost.exe " memIndex="1792" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <settings>
              <aCS name="CrawlerStorage" defaultValue="" />
              <aCS name="Microsoft.WindowsAzure.Plugins.Diagnostics.ConnectionString" defaultValue="" />
  ...
  <implements>
    <implementation Id="49e9f011-ad24-4b5f-8361-e40050abead3" ref="Microsoft.RedDog.Contract\ServiceContract\WebCrawlerContract@ServiceDefinition.build">
      <interfacereferences>
        <interfaceReference Id="bf53eb5a-b0c2-4760-b147-3d0303acbb3d" ref="Microsoft.RedDog.Contract\Interface\UserInterface:Endpoint1@ServiceDefinition.build">
          <inPort>
            <inPortMoniker name="/WebCrawler/WebCrawlerGroup/UserInterface:Endpoint1" />
          </inPort>
        </interfaceReference>
